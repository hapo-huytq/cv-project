    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview @if(Route::currentRouteName() == 'admin.users.index' || Route::currentRouteName() == 'admin.users.create' || Route::currentRouteName() == 'users_trash') active @endif">
                <a href="#">
                    <i class="fa fa-users" aria-hidden="true"></i> <span>HRs</span>
                    <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                </a>
                <ul class="treeview-menu">
                    <li @if(Route::currentRouteName() == 'admin.users.index') class="active" @endif><a href="{{route('admin.users.index')}}"><i class="fa fa-circle-o"></i> HRs list</a></li>
